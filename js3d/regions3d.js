  ...
  var NPC_TEMPLATES = {
    ...
    sylve: [
      ...
      { id: 'chamane', name: 'Chamane Yara', anchor: 'altar4', dx: -2, dy: 3, dir: 'right', colorMap: { j: 'd', l: '2' },
        dialog: ["Le marais des ombres cache Zacian, le loup des ténèbres.", "Ne le dérange qu'avec respect."] },
      ...
      { id: 'herboriste', name: 'Herboriste Faune', anchor: 'altar1', dx: 2, dy: -2, dir: 'down', colorMap: { j: 'd', l: 'c' },
        dialog: ["La canopée étincelante scintille au lever du jour.", "Raikou y chasse, dit-on, avec sa crinière électrique."] },
    ...
    saphir: [
      ...
      { id: 'plongeuse', name: 'Plongeuse Alia', anchor: 'altar0', dx: 2, dy: -2, dir: 'down', colorMap: { j: 'l', l: 'a' },
        dialog: ["L'Île du Léviathan est gardée par Kyogre.", "Personne n'a encore osé nager jusqu'au bout du récif."] },
    ...
    givre: [
      ...
      { id: 'ermite', name: 'Ermite Solveig', anchor: 'altar4', dx: 2, dy: -2, dir: 'down', colorMap: { j: 'd', l: 'c' },
        dialog: ["La Grotte aux Prismes chante quand le vent souffle.", "Diancie y façonne des bois de cristal, dit-on."] },
    ...
    braise: [
      ...
      { id: 'geologue', name: 'Géologue Petra', anchor: 'altar4', dx: 2, dy: -2, dir: 'down', colorMap: { j: 'd', l: '2' },
        dialog: ["Le champ d'obsidienne coupe comme du verre.", "Mewtwo y rôde, silencieux comme une ombre noire."] },
    ...
    aurore: [
      ...
      { id: 'archeologue', name: 'Archéologue Nadia', anchor: 'altar0', dx: 2, dy: -2, dir: 'down', colorMap: { j: 'g', l: '7' },
        dialog: ["Le Cercle des Menhirs est plus ancien que la cité elle-même.", "Registeel veille ici depuis des temps immémoriaux."] },
      ...
      { id: 'enfant_etoiles', name: 'Petite Luna', anchor: 'city', dx: -10, dy: 4, dir: 'right', colorMap: { j: 'j', l: 'a' },
        dialog: ["Je compte les étoiles filantes chaque soir.", "On dit que Palkia en fait tomber exprès pour nous !"] },
